...
var Flowchart = function (props) {
    ...
    return (React.createElement(AppContext.Provider, { value: { flowchartId: uuidv4Ref.current } },
        React.createElement("div", { className: "xflow-canvas-container", "data-flowchart-id": uuidv4Ref.current, ref: container, style: { width: '100%', height: '100%', backgroundColor: '#fff' } },
            React.createElement(XFlow, { className: className, style: style, commandConfig: commandConfig, hookConfig: hookConfig, onAppDestroy: onDestroy, isAutoCenter: isAutoCenter, onAppConfigReady: onConfigReady, onLoad: function (app) { return __awaiter(void 0, void 0, void 0, function () {
                    var X6Graph;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                ...
                nodePanelShow && React.createElement(FlowchartNodePanel, __assign({}, nodePanelProps)),
                React.createElement(FlowchartCanvas, { config: __assign(__assign({}, canvasProps), { onAddNode: onAddNode, onAddEdge: onAddEdge, onConfigChange: onConfigChange }), mode: mode, position: position },
                    show && (React.createElement(CanvasScaleToolbar, __assign({ layout: "horizontal", position: { top: 12, right: 12 }, style: {
                            width: 150,
                            left: 'auto',
