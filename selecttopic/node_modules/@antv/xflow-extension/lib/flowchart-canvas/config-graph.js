...
exports.useGraphConfig = (0, xflow_core_1.createGraphConfig)(function (config, proxy) {
    var _a = proxy.getValue(), _b = _a.config, canvasConfig = _b === void 0 ? {} : _b, useConfig = _a.useConfig, _c = _a.mode, mode = _c === void 0 ? 'edit' : _c;
    ...
    config.setEvents([
        ...
        },
        {
            ...
            callback: function (e) {
                mode === 'edit' && (0, utils_1.changePortsVisible)(true, e);
            },
        },
        {
